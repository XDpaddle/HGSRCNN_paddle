...
parser.add_argument('-opt', type=str, help='Path to options YMAL file.', default="config/train/train_lsgsrcnn_x2.yml")
...
paddle.save(ckpt_pd, 'trans_weights/trans_LSGSRCNN.pdparams')
a = 1